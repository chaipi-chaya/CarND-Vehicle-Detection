...
def search_windows(img, windows, clf, scaler, color_space='RGB', 
    ...
    return on_windows
def find_cars(img, ystart, ystop, cspace, scale, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_feat, hist_feat, spatial_size, hist_bins, hog_channel, all_windows=False):
